...
public class FirstAidActivity extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_firstaid, container, false);
        ...
        mGridView = (GridView) rootView.findViewById(R.id.firstaidgridView);
        ...
        //Start download
        new FirstAidActivity.AsyncHttpTask().execute(FEED_URL);
